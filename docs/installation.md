...
V3.0.1-beta.4 as an explicitly marked prerelease; V2.1.1 remains the rollback
...
2. Open
   `https://www.passion-wave.com/install/?v=3.0.1-beta.4`.
...
```text
https://www.passion-wave.com/firmware/rotaryknob/s3/manifest-3.0.1-beta.4.json
https://www.passion-wave.com/firmware/rotaryknob/esp32/manifest-3.0.1-beta.4.json
```
