...
**3.0.1-beta.4 — `reconnect-media-rehydration`**.
...
The public browser installer delivers **V3.0.1-beta.4** as an explicitly marked
...
- [Version 3.0.1-beta.4 release](RELEASE.md)
